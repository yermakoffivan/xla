...
TEST(HloDumpUtilsTest, ConvertHloToHtmlBasic) {
  ...
  annotations[TensorKey::Create("foo", {})] = {
      .background_color = "lightgreen", .tooltip_data = "\"my tooltip\""};
...
TEST(HloDumpUtilsTest, ConvertHloToHtmlTuple) {
  ...
  annotations[TensorKey::Create("bar", {0})] = {
      .background_color = "pink", .tooltip_data = "\"f32 tooltip\""};
  annotations[TensorKey::Create("bar", {1})] = {
      .background_color = "yellow", .tooltip_data = "\"s32 tooltip\""};
...
ENTRY %main.1 (x.1: f32[]) -> f32[] {
  ...
  annotations[TensorKey::Create("mul.10", {})] = {
      .background_color = "lightgreen", .tooltip_data = "\"mul.10 tooltip\""};
  annotations[TensorKey::Create("mul.19", {})] = {
      .background_color = "pink", .tooltip_data = "\"mul.19 tooltip\""};
...
TEST(HloDumpUtilsTest, ConvertHloToHtmlArbitraryColors) {
  ...
  annotations[TensorKey::Create("foo", {})] = {
      .background_color = "#123456", .tooltip_data = "\"hex tooltip\""};
...
TEST(HloDumpUtilsTest, ConvertHloToHtmlWithCompressedGraph) {
  ...
  graph_data.nodes.push_back({.id = 0,
                              .x = 1.0,
                              .y = 2.0,
                              .diff_score = 0.5,
                              .key = "foo",
                              .anchor_id = 0});
  graph_data.nodes.push_back({.id = 1,
                              .x = 2.0,
                              .y = 3.0,
                              .diff_score = 0.6,
                              .key = "bar",
                              .anchor_id = 1});
  graph_data.edges.push_back({.supplier_id = 0, .consumer_id = 1});
...
TEST(HloDumpUtilsTest, ConvertHloToHtmlCompactGte) {
  ...
  annotations[TensorKey::Create("p0_0", {})] = {
      ...
      .tooltip_data = "\"my compact GTE tooltip\""};
